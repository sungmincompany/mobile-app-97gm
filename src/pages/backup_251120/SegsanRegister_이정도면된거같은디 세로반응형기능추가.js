              ...
              <div style={gridContainerStyle}>
                      ...
                      <div>
                        ...
                        <div
                          style={{
                            ...
                            gap: "10px",
                            // ✅ [수정] 높이를 화면 크기에 맞게 유동적으로 변경 (기존 500px -> calc)
                            height: "calc(100vh - 340px)",
                            minHeight: "300px", // 너무 작아지지 않게 최소 높이 설정
                ...
                <div
                  style={{
                    ...
                    position: "sticky",
                    bottom: 0, // 화면 하단에 붙음
                    zIndex: 100, // 다른 요소 위에 떠 있음
                    backgroundColor: "#fff", // 뒤에 내용이 비치지 않도록 배경색 지정
                    paddingTop: "10px", // 위쪽 여백
                    paddingBottom: "10px", // 아래쪽 여백
                    borderTop: "1px solid #f0f0f0", // 경계선 추가 (선택사항)
                  }}
                >
                  <Button
                    size="large"
